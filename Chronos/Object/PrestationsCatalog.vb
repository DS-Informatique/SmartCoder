...
Public Class PrestationsCatalog
#Region "[Code]"
#Region "|1| [Property]{2}"
#Region "|01.00| <Property> [Current|Prestation_Category]"
    Private _Current As Prestation_Category
    Public Property Current() As Prestation_Category
        Get
            Return _Current
        End Get
        Set(ByVal value As Prestation_Category)
            ...
            If Not IsNothing(value) Then
                Input_Catégorie.Text = value.Ref
            End If
        End Set
    End Property
#End Region
...
#Region "|04.00| <Sub> [RefreshData]"
    Public Sub RefreshData()
        If IsNothing(List_Prestation_Category) Then
            ...
            List_Prestation_Category = Current_Prestation_Category.List
        Else
            If List_Prestation_Category.Count - 1 < 1 Then
                Current_Prestation_Category.Reset(New SmartCoder.M_FileManager.LineInfo(My.Settings.Db_TimeSheet_FilePath, My.Settings.Db_TimeSheet_Password))
                List_Prestation_Category = Current_Prestation_Category.List
            End If
        End If
        ...
        dataSource = List_Prestation_Category
        context = dataSource
    ...
    Private Sub LoadThread()
        Try
            If IsNothing(Current) Then
                Current = New Prestation_Category
            End If
...
#Region "|04.04| <Sub> [UpdateVcr]"
    ...
    Private Sub UpdateVcr()
        If _Bm.Position > _Bm.Count Then
            Current = List_Prestation_Category(_Bm.Count)
        ElseIf _Bm.Position < 0 Then
            Current = List_Prestation_Category(0)
        Else
            Current = List_Prestation_Category(_Bm.Position)
        End If
        ...
        Else
            If _Bm.Position = 0 Then
                ...
                Vcr1.Label.Text = "First of " & _Bm.Count & " records " & "|" & Current.Ref & "|"
            ElseIf _Bm.Position = _Bm.Count - 1 Then
                ...
                Vcr1.Label.Text = "Last of " & _Bm.Count & " records" & "|" & Current.Ref & "|"
            Else
                ...
                Vcr1.Label.Text = "Record " & (_Bm.Position + 1) & " of " & _Bm.Count & " " & "|" & Current.Ref & "|"
            End If
        End If
    End Sub
#End Region
...
#Region "|05.00| <Function> [InlineAssignHelper]"
    ...
    End Function
#End Region
#Region "|05.01| <Function> [RefreshPrestation_Category|Boolean]"
    Public Function RefreshPrestation_Category() As Boolean
        Dim Result As Boolean = False
        Dim LPrestation_Category As New List(Of Prestation_Category)
        LPrestation_Category = Current.List
        Dim Msg As String = ""
        If Input_Catégorie.Text = "" Then
...
#Region "|10.01| <Event> [Btn_Add_Click]"
    Private Sub Btn_Add_Click(sender As Object, e As EventArgs) Handles Btn_Add.Click
        ...
        Try
            Current = New Prestation_Category(Input_Catégorie.Text)

            Current.Add()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
        List_Prestation_Category = Current.List
        Try
            Current = List_Prestation_Category(0)
