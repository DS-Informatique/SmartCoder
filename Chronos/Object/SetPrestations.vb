...
#Region "[Code]"
#Region "|1| [Property]{2}"
#Region "|01.00| <Property> [Current|Prestations]"
    Private _Current As Prestations
    Public Property Current() As Prestations
        Get
            Return _Current
        End Get
...
#Region "|04.00| <Sub> [RefreshData]"
    Public Sub RefreshData()
        ...
        List_Prestations = Current_Prestations.List
        Input_Service.DataSource = List_Services
        Input_Type.DataSource = List_Prestation_Category
...
#Region "|04.04| <Sub> [UpdateVcr]"
    ...
    Private Sub UpdateVcr()
        If _Bm.Position > _Bm.Count Then
            Current = List_Prestations(_Bm.Count)
        ElseIf _Bm.Position < 0 Then
            Current = List_Prestations(0)
        Else
            Current = List_Prestations(_Bm.Position)
        End If
...
#Region "|05.01| <Function> [RefreshServices|Boolean]"
    Public Function RefreshPrestations() As Boolean
        Dim Result As Boolean = False
        Dim LPrestations As New List(Of Prestations)
        LPrestations = Current.List
        Dim Msg As String = ""
...
#Region "|10.00| <Event> [ButtonX1_Click]"
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        ...
        Input_ID.Value = List_Prestations.Count + 1
    End Sub
#End Region
#Region "|10.01| <Event> [Btn_Add_Click]"
    Private Sub Btn_Add_Click(sender As Object, e As EventArgs) Handles Btn_Add.Click
        ...
        Try
            Current = New Prestations(Input_ID.Value, Input_Description.Text, Input_Service.Text, Input_Type.Text)

            Current.Add()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
        List_Prestations = Current.List
        Try
            Current = List_Prestations(0)
