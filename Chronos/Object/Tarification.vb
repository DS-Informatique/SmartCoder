...
#End Region
    ...
    Private Sub Tarification_Load(sender As Object, e As EventArgs) Handles Me.Load
        RefreshData()
    ...
    Public Sub RefreshData()
        ...
        End If
        Input_Collaborateur.DataSource = Current_Collaborateur.List
        '   Current = List(0)
...
#End Region
    ...
    Private Sub Input_Mandat_TextChanged(sender As Object, e As EventArgs)
        Current.Code = Input_Mandat.Text
        ' PropCurrent.RefreshPropertyValues()
    End Sub

    Private Sub Input_Collaborateur_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub Btn_SendToExcel_Click(sender As Object, e As EventArgs) Handles Btn_SendToExcel.Click
        ...
        Try
            SmartCoder.ExcelDocument.Export_DataTable(SGC, "Tarifications.xlsx", Msg) 'My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\
