...
#Region"[On] |2019/07/17 00h08:138| <05.00.08> <Function> <> |.GetunitPrice()|Tarif}|"' (Set|Get) The GetunitPrice as Tarif.
    '''    <Summary>
...
'''    </Summary>
   ...
   Public Function GetunitPrice() As Tarif
 Dim Result As New List(Of TimeSheet)
            ...
            Return Result
   End Function
#End Region '(Set|Get) The GetunitPrice as Tarif.
...
#Region"[On] |2019/07/17 00h01:627| <01.00.08> <Property> <Virtualized Properties> |.Paste Errors()|Paste Errors|"' (Set|Get) 
   Private _Paste Errors As Paste Errors
    '''    <Summary>
'''     (Set|Get) 
'''    <AuthorEmail>saadry.dunkel@ds-informatique.ch</AuthorEmail>
'''    <AuthorName>David Shaw Informatique Sàrl</AuthorName>
...
'''    </Summary>
    <Browsable(True) , CategoryAttribute("Virtualized Properties") , Description("(Set|Get) ") >
   Public Property Paste Errors()As Paste Errors
       Get
       Return _Paste Errors
       End Get
       Set(ByVal Value As Paste Errors)
       _Paste Errors = Value
       End Set
   End Property
#End Region '(Set|Get) 

#Region"[On] |2019/07/17 00h01:634| <01.00.09> <Property> <List> |.List_Paste Errors()|List(Of Paste Errors)|"' (Set|Get) 
   Private _List_Paste Errors As List(Of Paste Errors)
    '''    <Summary>
'''     (Set|Get) 
'''    <AuthorEmail>saadry.dunkel@ds-informatique.ch</AuthorEmail>
'''    <AuthorName>David Shaw Informatique Sàrl</AuthorName>
...
'''    </Summary>
    <Browsable(True) , CategoryAttribute("List") , Description("(Set|Get) ") >
   Public Property List_Paste Errors()As List(Of Paste Errors)
       Get
       Return _List_Paste Errors
       End Get
       Set(ByVal Value As List(Of Paste Errors))
